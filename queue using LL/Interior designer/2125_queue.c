/*
                AUTHOR : 2125_ANKIT
                Roll no : 2125
                PROGRAM: IMPLEMENTATION FILE OF QUEUE
...
_Bool enqueue(eleType ip_data, qType *q1) //it insert item to the queue
{
...
eleType dequeue(qType* q1) //remove inserted item from queue and free that particular memory
 {   
    q1->count--;
    node* temp=q1->front;
...
void display_q(qType *q1) //display all the elements of the queue.
{
    node *point =q1->front;
